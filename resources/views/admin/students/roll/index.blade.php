...
<div class="col-md-12">
    ...
    <div class="card">
        ...
        <div class="card-header d-flex" style="justify-content: space-between;">
            ...
            <a href="{{route('admins.rollcreate')}}" class="btn btn-primary">Add new</a>
        </div>
        <div class="card-body">
            <table class="table table-head-bg-success">
                ...
                <tbody>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <a href="{{route('admins.studentshow', $roll->id)}}">{{$roll->roll_no}}</a>
                        </td>
                        <td>{{$roll->created_at}}</td>

                        <td>
                            <a href="{{route('admins.rolledit', 1)}}" data-toggle="tooltip" title="Edit Task" class="btn btn-link <btn-simple-primary">
